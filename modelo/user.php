<?php
function registrar($name,$lastname,$username,$password,$email) {
    $con = include "conexion.php";
    $query = "INSERT INTO usuarios (nombre, apellido, usuario, contraseña, email) VALUES ('$name', '$lastname', '$username', '$password', '$email')";
